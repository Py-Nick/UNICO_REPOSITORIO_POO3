        ...
        if loginForm.is_valid():
            ...
            if user is not None: 
                ...
                if _next is not None: 
                    ...
                    return redirect('/')
        else: message = {'type': 'danger', 'text': 'Dados de usuário incorretos'}
    else: loginForm = LoginForm() #sugestão da IA. se o método for get ele cria o formulário em branco
    #context e return devem ficar fora dos ifs para que a página rode
